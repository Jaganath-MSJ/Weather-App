export function formatDayTime(dateString, timeNeeded) {
  const daysOfWeek = [
    "Sunday",
    "Monday",
    "Tuesday",
  ...
  return `${dayOfWeekName} ${timeNeeded ? "| "+convertTo12HourFormat(dateString.split(" ")[1]) : ""}`;
}
...
export function get24Hours(timeString) {
